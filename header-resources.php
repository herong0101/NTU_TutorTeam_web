...
<div id="page" class="site">
  ...
  <header class="relative h-screen bg-cover bg-center" style="background-image: url('http://wp.local/wp-content/uploads/2025/07/教材資源背景圖_裁切.png');">
    ...
    <!-- Hero content like headline, button, etc. -->
      <div class="relative text-center mt-6">
        <h1 class="font-Zen-Old-Mincho font-bold text-9xl mb-10">教材資源</h1>
