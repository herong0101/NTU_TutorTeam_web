...
<div id="page" class="site">
  ...
  <header class="relative h-screen bg-cover bg-center" style="background-image: url('<?php echo get_theme_file_uri('/pictures/報名計畫_裁切.png'); ?>');">
    ...
    <!-- Hero content like headline, button, etc. -->
      <div class="relative text-center" style="margin-top: -10vh;">
        <h1 class="font-Zen-Old-Mincho font-bold text-7xl mb-10">登入升學種子，獲得更多資訊</h1>
